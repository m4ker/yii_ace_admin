...
<div class="main-container" id="main-container">
    ...
    <div id="sidebar" class="sidebar responsive">
        ...
        <ul class="nav nav-list">
            ...
            <?php if(isset($this->module) && $this->module->id == 'moduleA') { ?>

            <li class="<?php echo $this->id == 'actionA' ? 'active open' : ''; ?>">
                <a href="/moduleA/actionA/index"  >
                    <i class="menu-icon glyphicon glyphicon-file"></i>
                    <span class="menu-text"> actionA </span>
                </a>
            </li>
            <li class="<?php echo $this->id == 'actionB' ? 'active open' : ''; ?>">
                <a href="/moduleA/actionB/index"  >
                    <i class="menu-icon glyphicon glyphicon-search"></i>
                    <span class="menu-text"> actionB </span>
                </a>
            </li>
            <?php } else if (isset($this->module) && $this->module->id == 'moduleB') { ?>
                <li class="<?php echo $this->id == 'actionC' ? 'active open' : ''; ?>">
                    <a href="/moduleB/actionC/index"  >
                        <i class="menu-icon glyphicon glyphicon-picture"></i>
                        <span class="menu-text"> actionC </span>
                    </a>
                </li>
                <li class="<?php echo $this->id == 'actionD' ? 'active open' : ''; ?>">
                    <a href="/moduleB/actionD/index"  >
                        <i class="menu-icon glyphicon glyphicon-search"></i>
                        <span class="menu-text"> actionD </span>
                    </a>
                </li>
            <?php } else if (isset($this->module) && $this->module->id == 'moduleC') { ?>

            <?php } else { ?>
            <li class="<?php echo $this->id == 'actionE' ? 'active open' : ''; ?>">
                <a href="/actionE/index"  >
                    <i class="menu-icon fa fa-exclamation-circle"></i>
                    <span class="menu-text"> actionE </span>
                </a>
            </li>
            <li class="<?php echo $this->id == 'actionF' ? 'active open' : ''; ?>">
                <a href="/actionF/index"  >
                    <i class="menu-icon fa fa-folder"></i>
                    <span class="menu-text"> actionF </span>
                </a>
            </li>
            ...
            <li class="<?php echo $this->id == 'log' ? 'active open' : ''; ?>">
                <a href="<?php echo $this->createUrl('/log');?>"  >
